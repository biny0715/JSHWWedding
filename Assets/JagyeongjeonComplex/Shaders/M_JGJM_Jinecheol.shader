Shader "Unreal/M_JGJM_Jinecheol"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_JGJM_Jincheol_NM", 2D ) = "white" {}
		Material_Texture2D_1( "T_JGJM_Jincheol_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_JGJM_Jincheol_RN", 2D ) = "white" {}
