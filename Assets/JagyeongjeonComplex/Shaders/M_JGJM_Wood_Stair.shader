Shader "Unreal/M_JGJM_Wood_Stair"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_JGJM_Wood_Stair_NM", 2D ) = "white" {}
		Material_Texture2D_1( "T_JGJM_Wood_Stair_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_JGJM_Wood_Stair_RN", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_JGJM_Wood_Stair.hlsl"
