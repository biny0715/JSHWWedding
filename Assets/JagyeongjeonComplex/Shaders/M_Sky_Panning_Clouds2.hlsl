...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local39 = LWCToFloat(DERIV_BASE_VALUE(Local38));
	MaterialFloat Local40 = (GetPrimitiveData(Parameters).ObjectRadius * -0.10000000);
	MaterialFloat3 Local41 = (DERIV_BASE_VALUE(Local39) / ((MaterialFloat3)Local40));
	MaterialFloat Local42 = DERIV_BASE_VALUE(Local41).b;
	MaterialFloat Local43 = saturate(DERIV_BASE_VALUE(Local42));
	MaterialFloat Local44 = (1.00000000 - DERIV_BASE_VALUE(Local43));
	MaterialFloat Local45 = (DERIV_BASE_VALUE(Local44) * Material.PreshaderBuffer[14].y);
	MaterialFloat Local46 = lerp(0.00000000,Local36,DERIV_BASE_VALUE(Local45));
	MaterialFloat2 Local47 = (DERIV_BASE_VALUE(Local26) * ((MaterialFloat2)0.50000000));
	MaterialFloat Local48 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local47), 0);
	MaterialFloat4 Local49 = ProcessMaterialGreyscaleTextureLookup(Texture2DSampleBias(Material_Texture2D_2,samplerMaterial_Texture2D_2,DERIV_BASE_VALUE(Local47),View.MaterialTextureMipBias));
	MaterialFloat Local50 = MaterialStoreTexSample(Parameters, Local49, 0);
	MaterialFloat Local51 = lerp(Material.PreshaderBuffer[14].w,Material.PreshaderBuffer[14].z,Local49.r);
	MaterialFloat Local52 = PositiveClampedPow(Local46,Local51);
	MaterialFloat3 Local53 = (Material.PreshaderBuffer[15].xyz * ((MaterialFloat3)Local52));
	MaterialFloat Local54 = (Local16 * (1.00000000 / max(0.00001000,1.29999995)));
	MaterialFloat Local55 = (1.00000000 - Local54);
	MaterialFloat Local56 = (Local55 * 1.00000000);
	MaterialFloat Local57 = saturate(Local56);
	MaterialFloat Local58 = PositiveClampedPow(Local57,10.00000000);
	MaterialFloat Local59 = saturate(Local58);
	MaterialFloat3 Local60 = (((MaterialFloat3)Local59) * Material.PreshaderBuffer[11].yzw);
	MaterialFloat Local61 = (Local52 * Local52);
	MaterialFloat Local62 = (Local61 * 0.40000001);
	MaterialFloat3 Local63 = (Local60 * ((MaterialFloat3)Local62));
	MaterialFloat3 Local64 = (Local53 + Local63);
	MaterialFloat Local65 = saturate(Local61);
	MaterialFloat3 Local66 = lerp(Local22,Local64,Local65);
	MaterialFloat3 Local67 = (Local66 * Material.PreshaderBuffer[17].xyz);
	MaterialFloat3 Local68 = (Local67 * ((MaterialFloat3)1.50000000));
	MaterialFloat3 Local69 = lerp(Local68,Material.PreshaderBuffer[18].xyz,Material.PreshaderBuffer[17].w);
