Shader "Unreal/M_JGJM_Panelboard_D"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_JGJM_Panelboard_D_NM", 2D ) = "white" {}
		Material_Texture2D_1( "T_JGJM_Panelboard_D_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_JGJM_Panelboard_D_RN", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_JGJM_Panelboard_D.hlsl"
