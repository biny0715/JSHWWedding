Shader "Unreal/M_JGJM_PillarA"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_JGJM_PillarA_NM", 2D ) = "white" {}
		Material_Texture2D_1( "T_JGJM_PillarA_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_JGJM_PillarA_RN", 2D ) = "white" {}
