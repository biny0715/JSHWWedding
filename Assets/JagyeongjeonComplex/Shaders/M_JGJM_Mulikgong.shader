Shader "Unreal/M_JGJM_Mulikgong"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_JGJM_Mulikgong_NM", 2D ) = "white" {}
		Material_Texture2D_1( "T_JGJM_Mulikgong_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_JGJM_Mulikgong_RN", 2D ) = "white" {}
