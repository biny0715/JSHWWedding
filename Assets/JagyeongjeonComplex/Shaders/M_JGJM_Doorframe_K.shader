Shader "Unreal/M_JGJM_Doorframe_K"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_JGJM_Doorframe_K_NM", 2D ) = "white" {}
		Material_Texture2D_1( "T_JGJM_Doorframe_K_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_JGJM_Doorframe_K_RN", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_JGJM_Doorframe_K.hlsl"
