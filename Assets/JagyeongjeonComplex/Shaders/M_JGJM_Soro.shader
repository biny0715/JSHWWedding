Shader "Unreal/M_JGJM_Soro"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_JGJM_Soro_NM", 2D ) = "white" {}
		Material_Texture2D_1( "T_JGJM_Soro_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_JGJM_Soro_RN", 2D ) = "white" {}
