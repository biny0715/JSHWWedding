Shader "Unreal/M_JGJM_Ungong"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_JGJM_Ungong_NM", 2D ) = "white" {}
		Material_Texture2D_1( "T_JGJM_Ungong_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_JGJM_Ungong_RN", 2D ) = "white" {}
