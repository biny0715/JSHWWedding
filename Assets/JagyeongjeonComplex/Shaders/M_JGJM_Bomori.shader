Shader "Unreal/M_JGJM_Bomori"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_JGJM_Bomori_NM", 2D ) = "white" {}
		Material_Texture2D_1( "T_JGJM_Bomori_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_JGJM_Bomori_RN", 2D ) = "white" {}
