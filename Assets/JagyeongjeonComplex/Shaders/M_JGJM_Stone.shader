Shader "Unreal/M_JGJM_Stone"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_JGJM_Stone_NM", 2D ) = "white" {}
		Material_Texture2D_1( "T_JGJM_Stone_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_JGJM_Stone_RN", 2D ) = "white" {}
