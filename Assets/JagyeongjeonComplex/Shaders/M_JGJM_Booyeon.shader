Shader "Unreal/M_JGJM_Booyeon"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_JGJM_Booyeon_NM", 2D ) = "white" {}
		Material_Texture2D_1( "T_JGJM_Booyeon_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_JGJM_Booyeon_RN", 2D ) = "white" {}
