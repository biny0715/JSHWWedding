Shader "Unreal/M_JGJM_Entrance"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_JGJM_Entrance_NM", 2D ) = "white" {}
		Material_Texture2D_1( "T_JGJM_Entrance_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_JGJM_Entrance_RN", 2D ) = "white" {}
