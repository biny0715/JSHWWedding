Shader "Unreal/M_JGJM_Woodfloor_B"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_JGJM_Woodfloor_B_NM", 2D ) = "white" {}
		Material_Texture2D_1( "T_JGJM_Woodfloor_B_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_JGJM_Woodfloor_B_RN", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_JGJM_Woodfloor_B.hlsl"
