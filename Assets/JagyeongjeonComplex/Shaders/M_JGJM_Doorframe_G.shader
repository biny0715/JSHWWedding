Shader "Unreal/M_JGJM_Doorframe_G"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_JGJM_Doorframe_G_NM", 2D ) = "white" {}
		Material_Texture2D_1( "T_JGJM_Doorframe_G_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_JGJM_Doorframe_G_MT", 2D ) = "white" {}
		Material_Texture2D_3( "T_JGJM_Doorframe_G_RN", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_JGJM_Doorframe_G.hlsl"
