Shader "Unreal/M_JGJM_PillarB"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_JGJM_PillarB_NM", 2D ) = "white" {}
		Material_Texture2D_1( "T_JGJM_PillarB_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_JGJM_PillarB_RN", 2D ) = "white" {}
