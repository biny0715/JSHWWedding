Shader "Unreal/M_JGJM_Iikgong"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_JGJM_Iikgong_NM", 2D ) = "white" {}
		Material_Texture2D_1( "T_JGJM_Iikgong_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_JGJM_Iikgong_RN", 2D ) = "white" {}
